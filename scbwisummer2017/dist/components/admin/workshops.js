...
var Workshops = (function (_super) {
    __extends(Workshops, _super);
    function Workshops() {
        ...
        _this.handleChange = function (event, value) {
            var dispatch = _this.props.dispatch;
            dispatch(admin_1.makeWorkshop(__assign({}, _this.props.admin.tempworkshop, (_a = {}, _a[event.target.name] = value, _a))));
            var _a;
        };
        _this.save = function () {
            var dispatch = _this.props.dispatch;
            dispatch(admin_1.addWorkshop(_this.props.admin.tempworkshop));
        };
        _this.renderWorkshops = function () {
    ...
    Workshops.prototype.render = function () {
